...
import FriendListItem from "@/Components/App/FriendListItem.vue";
...
<template>
    <div class="p-3 bg-white border rounded h-full overflow-hidden">

        <div class="flex-1 block lg:hidden overflow-hidden">
            <Disclosure v-slot="{ open }">
                <DisclosureButton class="text-left w-full">
                    <div class="flex justify-between items-center">
                        <h2 class="text-2xl font-bold">My Friends</h2>
